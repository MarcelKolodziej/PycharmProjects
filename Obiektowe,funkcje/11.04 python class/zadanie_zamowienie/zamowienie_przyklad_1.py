...
def CreateStore(storefile):
    try:
        ...
        print
        "No Existing Store... generating items"
        makeStoreItems(4)
...
def printInstructions():
    print
    "Type C to view your cart items"
    print
    "Type R to item from your cart"
    print
    "Type an item number to buy it"
    print
    "Type P to get the total cart price"
    print
    "Type X to exit"
...
def handleInput(in_var, cart):
    ...
    if (in_var == "P"):
        print
        "The items in your cart currently cost"
        print
        cart.priceCart()
    if (in_var == "X"):
        global done
